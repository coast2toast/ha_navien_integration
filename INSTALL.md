...
This package contains the `navien_navilink_wh` custom integration published at
https://github.com/coast2toast/ha_navien_integration. It is based on
`lasswellt/navien-homeassistant` release `2026.06.03` (commit
`b8c595658c5fb3b90bfbcc2818c21df91cfbe055`), is MIT-licensed, and has been
validated against a live NaviLink-connected NPE-2.
...
4. Enter `https://github.com/coast2toast/ha_navien_integration`.
...
- All 45 automated tests passed under Python 3.13 and Home Assistant 2026.2.3.
...
- Live login, device discovery, telemetry, and power control were validated with
  a NaviLink-connected NPE-2.

The integration is cloud-dependent and unofficial; Navien may change the service
without notice.
...
- Download redacted diagnostics from the integration's device page when opening an issue:
  https://github.com/coast2toast/ha_navien_integration/issues
